...
Contexto de projeto vem da raiz: [`../AGENTS.md`](../AGENTS.md) (decisões adotadas) e [`../.agents/rules/react-frontend.mdc`](../.agents/rules/react-frontend.mdc) (stack, estrutura, auth, armadilhas do contrato — ler antes de codar neste diretório).
