...
export type StorageHash =
  StorageHashBase<'2e70f946b86b01e5c9ab19d707febadf065d73e0cec903104f88f622f0f61593'>;
export type ExecutionHash =
  ExecutionHashBase<'75159b9a22b572da057d44ff5d9cec639660918393aeb77aec1923dedb57c29d'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Integration: {
      ...
      readonly type: 'WEBHOOK' | 'REST_API' | 'N8N';
      readonly targetUrl: CodecTypes['pg/text@1']['output'];
      readonly authKey: CodecTypes['pg/text@1']['output'] | null;
      readonly customHeaders: CodecTypes['pg/json@1']['output'] | null;
      readonly defaultPayload: CodecTypes['pg/json@1']['output'] | null;
      readonly isActive: CodecTypes['pg/bool@1']['output'];
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
      readonly updatedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
    readonly IntegrationExecution: {
      readonly id: CodecTypes['pg/uuid@1']['output'];
      readonly integrationId: CodecTypes['pg/uuid@1']['output'];
      readonly status: 'SUCCESS' | 'FAILURE';
      readonly httpStatusCode: CodecTypes['pg/int4@1']['output'] | null;
      readonly responseTimeMs: CodecTypes['pg/int4@1']['output'];
      readonly requestPayload: CodecTypes['pg/json@1']['output'] | null;
      readonly responseBody: CodecTypes['pg/text@1']['output'] | null;
      readonly executedAt: CodecTypes['pg/timestamptz-string@1']['output'];
    };
...
export type FieldInputTypes = {
  readonly public: {
    readonly Integration: {
      ...
      readonly type: 'WEBHOOK' | 'REST_API' | 'N8N';
      readonly targetUrl: CodecTypes['pg/text@1']['input'];
      readonly authKey: CodecTypes['pg/text@1']['input'] | null;
      readonly customHeaders: CodecTypes['pg/json@1']['input'] | null;
      readonly defaultPayload: CodecTypes['pg/json@1']['input'] | null;
    ...
    readonly IntegrationExecution: {
      readonly id: CodecTypes['pg/uuid@1']['input'];
      readonly integrationId: CodecTypes['pg/uuid@1']['input'];
      readonly status: 'SUCCESS' | 'FAILURE';
      readonly httpStatusCode: CodecTypes['pg/int4@1']['input'] | null;
      readonly responseTimeMs: CodecTypes['pg/int4@1']['input'];
      readonly requestPayload: CodecTypes['pg/json@1']['input'] | null;
      readonly responseBody: CodecTypes['pg/text@1']['input'] | null;
      readonly executedAt: CodecTypes['pg/timestamptz-string@1']['input'];
    };
    readonly RefreshToken: {
      readonly id: CodecTypes['pg/uuid@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            readonly integration: {
              ...
              indexes: readonly [
                {
                  readonly name: 'integration_tenantId_updatedAt_idx_dd16144d';
                  readonly prefix: 'integration_tenantId_updatedAt_idx';
                  readonly columns: readonly ['tenantId', 'updatedAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'integration_tenantId_idx_c93ed4f1';
                  readonly prefix: 'integration_tenantId_idx';
            ...
            readonly integrationExecution: {
              ...
              indexes: readonly [
                {
                  readonly name: 'integrationExecution_integrationId_executedAt_idx_24893e17';
                  readonly prefix: 'integrationExecution_integrationId_executedAt_idx';
                  readonly columns: readonly ['integrationId', 'executedAt'];
                  readonly unique: false;
                },
                {
                  readonly name: 'integrationExecution_integrationId_idx_c1110add';
                  readonly prefix: 'integrationExecution_integrationId_idx';
              ...
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'integrationExecution';
                    readonly columns: readonly ['integrationId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
          ...
          readonly valueSet: {
            ...
            readonly IntegrationType: {
              readonly kind: 'valueSet';
              readonly values: readonly ['WEBHOOK', 'REST_API', 'N8N'];
            };
            readonly Role: {
              readonly kind: 'valueSet';
              readonly values: readonly ['ADMIN', 'VIEWER'];
            };
          };
        };
      };
...
> & {
  ...
  readonly roots: {
    ...
    readonly integrationExecution: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'IntegrationExecution';
    };
    readonly refreshToken: {
      readonly namespace: 'public' & NamespaceId;
      ...
      readonly public: {
        readonly models: {
          readonly Integration: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly targetUrl: { readonly column: 'targetUrl' };
                readonly authKey: { readonly column: 'authKey' };
                readonly customHeaders: { readonly column: 'customHeaders' };
                readonly defaultPayload: { readonly column: 'defaultPayload' };
          ...
          readonly IntegrationExecution: {
            ...
            readonly storage: {
              readonly table: 'integrationExecution';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly integrationId: { readonly column: 'integrationId' };
                readonly status: { readonly column: 'status' };
                readonly httpStatusCode: { readonly column: 'httpStatusCode' };
                readonly responseTimeMs: { readonly column: 'responseTimeMs' };
                readonly requestPayload: { readonly column: 'requestPayload' };
        ...
        readonly enum: {
          ...
          readonly IntegrationType: {
            ...
            readonly members: readonly [
              ...
              { readonly name: 'REST_API'; readonly value: 'REST_API' },
              { readonly name: 'N8N'; readonly value: 'N8N' },
            ];
          };
          readonly ExecutionStatus: {
            readonly codecId: 'pg/text@1';
