...
**Encaminhamento (2026-09-06):** coberto pela entrega **F12** de [`docs/plans/frontend/f12-production.md`](../../plans/frontend/f12-production.md) — o `nginx.conf` do serviço `frontend` proxia todo o prefixo `/api/` (não só `/api/v1/`). **Apagar este arquivo** ao concluir F12.
